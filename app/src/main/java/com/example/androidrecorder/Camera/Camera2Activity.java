...
public class Camera2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private CameraManager mCameraManager;//查询和建立相机连接的系统服务
    private String mFrontCameraId;//前置摄像头Id
    private CameraCharacteristics mFrontCameraCharacteristics;//装载前置摄像头的所有信息类
    private String mBackCameraId;//后置摄像头信息
    private String mCameraId;//当前使用的摄像头信息
    private CameraCharacteristics mBackCameraCharacteristics;//装载后置摄像头的所有信息类
    ...
    /**
     * 初始化相机，和配置相关属性
     * 1.将相机装载到CameraCharacteristics 中
     * 2.根据指定的相机ID连接相机
     * 3.提供将闪光灯等设置方式
     */
    private void initCamera(){
        ...
        try{
            ...
            //遍历设备支持的相机Id，比如前置、后置等
            String[] cameraIdList = mCameraManager.getCameraIdList();
            for(String cameraId: cameraIdList){
                //拿到装载所有相机信息的CameraCharacteristics类
